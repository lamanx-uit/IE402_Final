...
export const setupScene = () => {
  ...
  camera.position.set(0, 2, 0); // position camera in center of room
  ...
  // Fix color space to prevent color shifts (brown appearing red-brown)
  renderer.outputColorSpace = THREE.SRGBColorSpace; // Use sRGB color space for accurate colors
